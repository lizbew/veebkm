...
public class BkmDatabaseServiceVertxEBProxy implements BkmDatabaseService {
  ...
  public BkmDatabaseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public BkmDatabaseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public BkmDatabaseService fetchAllBookmarks(Handler<AsyncResult<JsonArray>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "fetchAllBookmarks");
  ...
  public BkmDatabaseService fetchBookmark(String title, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchBookmark");
  ...
  public BkmDatabaseService fetchBookmarkById(int id, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchBookmarkById");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public BkmDatabaseService createBookmark(String title, String url, Handler<AsyncResult<Void>> resultHandler) {
    ...
    _json.put("url", url);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "createBookmark");
  ...
  public BkmDatabaseService saveBookmark(int id, String url, Handler<AsyncResult<Void>> resultHandler) {
    ...
    _json.put("url", url);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "saveBookmark");
    _vertx.eventBus().<Void>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public BkmDatabaseService deleteBookmark(int id, Handler<AsyncResult<Void>> resultHandler) {
    ...
    _json.put("id", id);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "deleteBookmark");
    _vertx.eventBus().<Void>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public BkmDatabaseService fetchAllBookmarksData(Handler<AsyncResult<List<JsonObject>>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchAllBookmarksData");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
